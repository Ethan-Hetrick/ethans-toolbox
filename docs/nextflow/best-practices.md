...
- [ ] **Modularization**: Each process should be contained in it's own module file (`projectDir/modules` in nf-core pipeline structure). Workflows and subworkflows should be staged to reduce redundancy and enhance readability of the code base. If you re-use a multi-step analysis in your pipeline, you want to make that it's own workflow. For readability, you may want to organize it intuitively. E.g. workflow: 'PREPROCESSING', 'PROCESSING', 'REPORTING'
